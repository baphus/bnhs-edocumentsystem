...
class RequestController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render("Registrar/Requests/Index", [
            "requests" => $requests,
    ...
    public function create(): Response
    {
        ...
        return Inertia::render("Registrar/Requests/Create", [
            "documentTypes" => $documentTypes,
            "gradeLevels" => $this->getGradeLevels(),
            "trackStrands" => $this->getTrackStrands(),
            "schoolYears" => $this->getSchoolYears(),
    ...
    public function show(DocumentRequest $documentRequest): Response
    {
        ...
        return Inertia::render("Registrar/Requests/Show", [
            "request" => [
    ...
    public function updateStatus(Request $request, DocumentRequest $documentRequest)
    {
        ...
        try {
            ...
            // Log error but dont fail the status update
